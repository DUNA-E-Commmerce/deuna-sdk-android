...
class DeunaActivity : AppCompatActivity() {
  ...
  override fun onCreate(savedInstanceState: Bundle?) {
    ...
    scope.launch {
      ...
      val closeEvents = closeEventAsStrings.mapNotNull { stringValue ->
        try {
          enumValueOf<CheckoutEvent>(stringValue)
  ...
  private fun launchActivity(url: String, closeOnEvents: Set<CheckoutEvent>) {
  ...
  private fun setupWebView(
    webView: WebView,
    url: String,
    closeOnEvents: Set<CheckoutEvent>,
  ) {
